    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLoginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(password.length() < 6) {
                    mPassword.setError("Password Length has to be 6 Characters or More");
                    return;
                }
        ...
        forgotTextLink.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                passwordResetDialog.setMessage("Enter Your Email To Receive Reset Email");
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        fAuth.sendPasswordResetEmail(mail).addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                Toast.makeText(Login.this, "Reset Links has been Sent to Your Email", Toast.LENGTH_LONG).show();
                            }
